...
class ExamTemplate(db.Model):
    ...
    template_questions = db.relationship('ExamTemplateQuestion', backref='template', lazy=True, cascade='all, delete-orphan')
...
class ExamTemplateQuestion(db.Model):
    ...
    # 关系
    question = db.relationship('Question', backref=db.backref('template_questions', cascade='all, delete-orphan'))
