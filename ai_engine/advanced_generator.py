...
class AdvancedQuestionGenerator:
        ...
        return {
            "shopping_scenario": [
                ...
                },
                {
                    ...
                    "answer_formula": lambda vars: min(
                        ...
                        (
                            vars["needed_qty"] * vars["wholesale_price"]
                            if vars["needed_qty"] >= vars["min_qty"]
                            else float("inf")
                        ),
                    ),
                },
            ...
            "probability_statistics": [
                ...
                },
                {
                    ...
                    "answer_formula": lambda vars: self._calculate_dice_probability(
                        vars["dice_count"], vars["target_sum"]
                    ),
                },
                {
            ...
            "investment_finance": [
                ...
                },
                {
                    ...
                    "variables": {
                        ...
                        "calculation_target": lambda: random.choice(
                            [
                                "每月还款金额是多少",
                                "总利息是多少",
                                "第一年还款总额是多少",
    ...
    def _generate_single_unique_question(
        self,
        index: int,
        strategy: str,
    ...
    def _generate_options(self, correct_answer: float, question_type: str, language: str) -> List[str]:
        ...
        if isinstance(correct_answer, (int, float)):
            ...
            if question_type in [
                ...
                "bulk_discount_analysis",
                "promotional_pricing",
                "currency_exchange_shopping",
...
def generate_advanced_questions(
    count: int, difficulty: str, language: str, subject: str, custom_prompt: str = ""
) -> List[Dict[str, Any]]:
    """便捷的题目生成函数"""
